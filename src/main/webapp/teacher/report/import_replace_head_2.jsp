...
<img src="${url}/images/sendmail/logo_2.png">
<div >
	<div style="font-weight: bold;color: #F00;">提示1:上传的图片必须使用PNG格式<br/>提示2:分辨率:861*179 文件大小:50KB以内</div>
	<div id="mmsg" style="font-weight: bold;color: #F00;">${msg }</div>
		
	<form action="${cxt}/report/saveReplaceImage" method="post" id="searchForm" enctype="multipart/form-data"> 
		<div style="margin-bottom: 20px;">
			<samp>请选择文件：</samp> 
			<input type="file" name="fileField" class="file" id="fileField" accept="image/x-png"/> 
		</div>
		<div>
			<input type="hidden" name="type" id="type" value="head">

...
public class ImportCourse {
	...
	public static final String mustTab = "COURSE_NAME,";//必填项
	static{
		tabMap.put("课程名称", "COURSE_NAME");			mapTab.put("COURSE_NAME", "课程名称");
//		tabMap.put("课时单价", "UNIT_PRICE");			mapTab.put("UNIT_PRICE", "课时单价");
